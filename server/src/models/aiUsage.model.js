...
const aiUsageSchema = new mongoose.Schema(
  {
    ...
    retrievalLatency: { type: Number },
    openAiLatency: { type: Number },
    generationLatency: { type: Number },
    totalPipelineLatency: { type: Number },
    ...
    rerankedChunks: { type: Number },
    finalChunks: { type: Number },
